...
describe("Applications API", () => {
  beforeEach(() => {
    jest.clearAllMocks();
    prismaMock.user.findUnique.mockResolvedValue({ id: "user-1", name: "Nurlan", email: "nurlan@mail.com" });
  });
  ...
  test("creates an application for the authenticated user", async () => {
    ...
    const response = await request(app)
      ...
      .set(authHeader)
      .send({ companyName: "QB Solutions", positionTitle: "Fullstack Developer", status: "Applied", priority: "High" });
